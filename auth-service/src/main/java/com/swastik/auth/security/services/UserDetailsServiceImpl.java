package com.swastik.auth.security.services;

import com.swastik.auth.models.User; // Import User model
import com.swastik.auth.repository.UserRepository; // Import UserRepository for user database operations
