package com.swastik.auth.security;

import com.swastik.auth.security.jwt.AuthEntryPointJwt; // Import for unauthorized access handler
import com.swastik.auth.security.jwt.AuthTokenFilter; // Import for JWT token filter
import com.swastik.auth.security.services.UserDetailsServiceImpl; // Import for user details service implementation
