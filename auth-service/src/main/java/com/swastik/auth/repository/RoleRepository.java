package com.swastik.auth.repository;

import java.util.Optional; // Import Optional for handling optional values

import com.swastik.auth.models.UserRole; // Import UserRole enumeration
import com.swastik.auth.models.Role; // Import Role model
