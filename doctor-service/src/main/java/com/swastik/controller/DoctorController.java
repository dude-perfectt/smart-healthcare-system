...
import com.swastik.model.Doctor;
import com.swastik.payload.response.GenericResponse;
import com.swastik.services.DoctorService;
...
public class DoctorController {
    ...
    @PostMapping
    public ResponseEntity<?> saveDoctor(@Valid @RequestBody com.swastik.payload.request.Doctor doctor) throws Exception {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateDoctor(@Valid @RequestBody com.swastik.payload.request.Doctor doctor, @PathVariable String id) throws Exception {
        try {
