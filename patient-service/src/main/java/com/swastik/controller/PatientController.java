package com.swastik.controller;

import com.swastik.exception.ResourceNotFoundException;
import com.swastik.payload.request.Patient;
import com.swastik.payload.response.GenericResponse;
import com.swastik.services.PatientService;
...
public class PatientController {
    ...
    public ResponseEntity<?> getPatientById(@PathVariable String id) throws ResourceNotFoundException {
        try {
            com.swastik.model.Patient patient = patientService.getPatientById(id);
    ...
    public ResponseEntity<?> getPatientByEmail(@PathVariable String email) throws ResourceNotFoundException {
        try {
            com.swastik.model.Patient patient = patientService.getPatientByEmail(email);
    ...
    public ResponseEntity<?> getAllPatients() throws Exception {
        try {
            List<com.swastik.model.Patient> patients = patientService.getAllPatients();
    ...
    @PostMapping("/")
    public ResponseEntity<?> savePatient(@Valid @RequestBody com.swastik.payload.request.Patient patient) throws Exception {
        try {
            com.swastik.model.Patient savedPatient = patientService.addPatient(patient);
    ...
    public ResponseEntity<?> updatePatient(@Valid @RequestBody Patient patient, @PathVariable String id) throws Exception {
        try {
            com.swastik.model.Patient updatedPatient = patientService.updatePatientById(id, patient);
